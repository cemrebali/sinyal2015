function[x,t]=note(frekans,vurus)%sinüs sinyali çizdiren fonksiyon
    fs=8192;%örnekleme sayısı değişkeni
    t=0:1/fs:vurus-(1/fs); %sinyal periyodu 
       a=length(t);%periyod boyutu değişkene atandı
    hk=[1 0.8 0.4 0.1]; %harmonik katsayıları dizeye atandı.
        b=length(hk); %harmonik kkatsayıları dizisinin boyutu b değişkenine atandı
